...
### About the Project
This project simulates a cloth and generates PNG frames. You can combine these frames into a video using ffmpeg.
...
### Proje Hakkında
Bu proje, kumaş simülasyonu ve kare kare PNG çıktısı üretimi yapar. Sonrasında bu karelerden video oluşturabilirsiniz (ffmpeg ile).
